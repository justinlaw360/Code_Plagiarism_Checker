...
def check_code_plagiarism(source_folder, sink_folder, threshold=0.8, output_csv='c:/Temp/code_similarity_report_py.csv'):
...
# Example usage:
# check_code_plagiarism("C:/Temp/source", "C:/Temp/sink")
# Example usage
